function varargout = LUNG_Detect(varargin)
% LUNG_DETECT MATLAB code for LUNG_Detect.fig
%      LUNG_DETECT, by itself, creates a new LUNG_DETECT or raises the existing
%      singleton*.
%
%      H = LUNG_DETECT returns the handle to a new LUNG_DETECT or the handle to
%      the existing singleton*.
%
%      LUNG_DETECT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LUNG_DETECT.M with the given input arguments.
%
%      LUNG_DETECT('Property','Value',...) creates a new LUNG_DETECT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before LUNG_Detect_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to LUNG_Detect_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help LUNG_Detect
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @LUNG_Detect_OpeningFcn, ...
                   'gui_OutputFcn',  @LUNG_Detect_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before LUNG_Detect is made visible.
function LUNG_Detect_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to LUNG_Detect (see VARARGIN)

% Choose default command line output for LUNG_Detect
...
% UIWAIT makes LUNG_Detect wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = LUNG_Detect_OutputFcn(hObject, eventdata, handles) 
...
if fname~=0
    ...
    a=img;
       axes(handles.axes1); imshow(img); title('CT Image');
else
